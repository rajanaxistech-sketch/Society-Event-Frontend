...
/**
 * Compresses and resizes an image File using HTML5 Canvas to a lightweight data URL (JPEG).
 * Prevents uploading huge multi-megabyte payloads that cause network timeouts.
 */

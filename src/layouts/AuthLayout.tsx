  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-[#F3F4FA] text-[#1E293B] flex flex-col justify-center py-8 sm:py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="w-full sm:mx-auto sm:max-w-md text-center z-10">
        <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-tr from-[#6366F1] to-[#8B5CF6] text-white shadow-soft mb-3 sm:mb-4">
          <Sparkles className="w-6 h-6 sm:w-7 sm:h-7" />
        </div>
        <h2 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight px-2">
          Society & Community Hub
        </h2>
        <p className="mt-1 sm:mt-1.5 text-xs text-slate-500">
      ...
      <div className="mt-6 sm:mt-8 w-full sm:mx-auto sm:max-w-md z-10">
        <div className="bg-white py-7 px-5 sm:py-9 sm:px-10 shadow-card rounded-2xl border border-[#E2E8F0]">
          <Outlet />
        </div>
      </div>

    ...
    <div className="max-w-3xl mx-auto space-y-3.5">
      ...
      {isReversed && (
        <div className="p-3 bg-rose-50 border border-rose-200 rounded-lg flex items-start gap-2.5">
          ...
          <div>
            <h4 className="text-[11px] font-bold text-rose-900 uppercase">Payment Reversed</h4>
      ...
      >
        <div className="space-y-3.5">
          {/* Amount Paid Banner */}
          <div className="p-3.5 bg-gradient-to-r from-indigo-50 to-slate-50 rounded-lg border border-indigo-100 flex items-center justify-between">
            <div>
              ...
              <CurrencyDisplay
                ...
                className="text-2xl font-extrabold text-indigo-950 mt-0.5 block"
              />
            </div>
            <div className="text-right text-xs">
              <span className="text-slate-400 block text-[11px]">Payment Mode</span>
              <span className="font-bold text-slate-800 text-xs">{payment.payment_method?.name || 'Cash'}</span>
            </div>
          </div>

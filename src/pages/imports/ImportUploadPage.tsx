          ...
          <div className="space-y-6">
                ...
                <div className="p-3 bg-slate-50 rounded-lg border border-slate-200 flex items-center justify-between text-xs">
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      type="button"
                      onClick={() => handleDownloadTemplate('csv')}
                      className="px-2.5 py-1 text-xs font-semibold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 rounded-md transition-colors inline-flex items-center gap-1"
                    >
                    ...
                    <button
                      type="button"
                      onClick={() => handleDownloadTemplate('xlsx')}
                      className="px-2.5 py-1 text-xs font-semibold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 rounded-md transition-colors inline-flex items-center gap-1"
                    >
            ...
            <div className="p-4 bg-indigo-50/40 rounded-xl border border-indigo-100 space-y-3">
              <div className="flex items-start justify-between gap-2">
                ...
                <span className="text-[11px] text-indigo-600 font-medium">Auto-mapped by Header Names</span>
              </div>
              <p className="text-xs text-slate-600">{currentGuide.description}</p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs pt-1">
                <div>
                  <span className="font-semibold text-slate-700 block mb-1">Required Columns:</span>
                ...
                <div>
                  <span className="font-semibold text-slate-700 block mb-1">Optional Columns:</span>
                  <div className="flex flex-wrap gap-1.5">
                ...
                <label htmlFor="file-upload" className="cursor-pointer block">
                  ...
                  {selectedFile ? (
                    ...
                    <div>
                      ...
                      <span className="text-[11px] text-slate-400">Supports .CSV, .XLSX, .XLS up to 10MB</span>
                    </div>
                  )}
                </label>
              </div>

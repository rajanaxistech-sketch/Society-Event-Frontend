        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-lg sm:text-xl font-bold text-slate-900 tracking-tight">{role.name}</h1>
              <span
              ...
              <div key={modName} className="p-2.5 rounded-xl border border-slate-200 bg-slate-50/50">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-1.5">
                  {perms.map((p: any) => (
                    <div
                      key={p.id}
                      className="p-2 rounded-lg border border-slate-200 bg-white text-xs flex items-start gap-1.5 shadow-2xs"
                    >
